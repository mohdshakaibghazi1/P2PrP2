...
namespace WebApplication2.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(RainbowSchoolManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Subject != null ? 
                          ...
                          Problem("Entity set 'RainbowSchoolManagementContext.Subject'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RainbowSchoolManagementContext.Subject'  is null.");
            }
            var subject = await _context.Subject.FindAsync(id);
            if (subject != null)
            {
